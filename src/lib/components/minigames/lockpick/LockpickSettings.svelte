		...
		>
			...
			>
				<div class="flex items-center gap-2">
					...
					<span class="font-bold italic uppercase tracking-wider text-white"
						>Settings</span
					>
					<span
				...
				<Button
					...
					class="px-0 py-0 text-[11px] underline"
				>
				...
				<label class="block">
					<span class="mb-1 flex justify-between text-neutral-400">
						...
						<span class="font-bold font-mono text-white"
							>{snapshot.decayRate.toFixed(1)}% / s</span
						>
					</span>
					<input
						type="range"
