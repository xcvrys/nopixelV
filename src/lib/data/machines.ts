...
export const STARTER_MACHINES: MachineDefinition[] = [
	{
		...
		defaultDuration: 3,
		defaultPowerCost: 2,
		description: 'High-temperature industrial furnace used for smelting scrap metal and crude ores into refined ingots.'
	},
	{
		id: 'processor',
		type: 'processor',
		...
		defaultDuration: 4,
		defaultPowerCost: 4,
		description: 'Precision machining table for pressing plates, extruding wiring, and assembling high-tech components.'
	},
	{
		id: 'splitter',
		type: 'splitter',
		...
		defaultDuration: 0,
		defaultPowerCost: 0,
		description: 'Splits incoming conveyor item streams evenly across multiple outbound conveyor lines.'
	},
	{
		id: 'merger',
		type: 'merger',
		...
		defaultDuration: 0,
		defaultPowerCost: 0,
		description: 'Combines multiple incoming conveyor item streams into a single outbound conveyor line.'
	},
	{
		id: 'storage',
		type: 'storage',
